...
class Turmas:
    ...
    def qnt_alunos(self):
        print('Total de alunos na turma de', self.atividade, ':', len(self.alunos))

    def mostrar_alunos(self):
        print('Alunos matriculados na turma de', self.atividade)
...
instrutor2=Instrutor(47823456, 'Roger', 7/10/1990, 27316573,'Pós Graduação em Natação')
...
# Relatório da turma de dança

turma_danca.qnt_alunos()
turma_danca.mostrar_alunos()
print('RG:', aluno1.get_rg())
print('RG:', aluno3.get_rg())
print('Instrutor de zumba: ', turma_danca.instrutor.nome)
print('Aluno monitor de zumba: ', turma_danca.monitor.nome)

# Relatório da turma de natação

turma_natacao.qnt_alunos()
turma_natacao.mostrar_alunos()
print('RG:', aluno2.get_rg())
print('RG:', aluno3.get_rg())
print('Instrutor de nado livre: ', turma_natacao.instrutor.nome)
print('Aluno monitor de nado livre: ', turma_natacao.monitor.nome)

# Relatório da turma de musculação
...
print('RG:', aluno2.get_rg())
print('RG:', aluno3.get_rg())
print('Instrutor de musculação: ', turma_musculacao.instrutor.nome)
print('Aluno monitor de musculação: ', turma_musculacao.monitor.nome)